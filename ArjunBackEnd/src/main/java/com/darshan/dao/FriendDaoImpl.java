...
private SessionFactory sessionFactory;
	...
	public List<User> getSuggestedUsers(User user) {
		...
		SQLQuery query=session.createSQLQuery("select * from Arjun where username in (select username from Arjun where username!=? minus (select from_id from friends where to_id=?"
